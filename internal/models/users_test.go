...
import (
	"github/len4ernova/lets_go/internal/assert"
	"testing"
)
...
//
//	go test -coverprofile=/tmp/profile.out ./...    -  запишет профиль покрытия
//	go test -covermode=count -coverprofile=/tmp/profile.out ./...   -  насыщенность цвета
//	go tool cover -html=/tmp/profile.out
//
// -covermode=atomic   - точное колв-о
